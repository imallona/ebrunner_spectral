...
ID=20220629.B-o2875513-SPECTRAL_3
...
ID=20220629.B-o2875512-SPECTRAL_2
...
WD=/home/imallona/ebrunner_spectral/harmonize_fastqs/"$ID"
DATA=/home/gmoro/fastqs_six_scRNAseq_separated
...
for fastq in $(find $DATA -name "*R1.fastq.gz")
do
    echo $fastq
