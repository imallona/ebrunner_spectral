...
genes_RR_TSO <- read_tsv("/home/gmoro/RStudio/Cell_line_exp/features_RR_TSO_new.tsv", col_names = FALSE)
gene_ids_RR_TSO <- genes_RR_TSO$X2 # ensembl would be X1

cell_ids_RR_TSO <- read_tsv("/home/gmoro/RStudio/Cell_line_exp/barcodes_RR_TSO_new.tsv", col_names = FALSE)$X1

rownames(counts_RR_TSO) <- gene_ids_RR_TSO
colnames(counts_RR_TSO) <- cell_ids_RR_TSO

rowSums(head(counts_RR_TSO,17))
