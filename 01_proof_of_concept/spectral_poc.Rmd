...
if (params$chromosome == 'all') {
    ...
    grepsys <- sprintf('LC_ALL=C fgrep -w %s %s', params$chromosome, MAPPING)
...
write.table(file = sprintf('fd_chr_%s.tsv', params$chromosome),
            x = fd, row.names = FALSE, col.names = TRUE, quote = FALSE)
```
