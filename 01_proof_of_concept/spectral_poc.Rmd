...
suppressPackageStartupMessages({
    ...
    ## for Shannon's entropy (categorical)
    library('msu')            
    library('data.table')
    ## library('Matrix')
    ## library('foreach')
...
Compound scoring. The current score favours (linearly, unweighted): number of transcripts covered, `seldom_tx_score`, Shannon entropy (a measure of probe complexity), having a GC content in a safe range (40 < x < 60 Celsius), and lacking homopolymers (absence of 4-mers).
