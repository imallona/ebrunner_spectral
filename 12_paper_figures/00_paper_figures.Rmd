...
```{r}
lapply(d, function(x) lapply(x, function (x) head(x@meta.data)))
```

```{r}
saveRDS(object = d, file = 'all_seurats.rds')
```

# Analysis requirements

- https://docs.google.com/document/d/1efpNDMb91Dpk4ZXBZBl5n29xzjIMwK2bfXioc9nHDpE/edit
- http://imlstaupo.uzh.ch/imallona/ebrunner/04_descriptive_analysis_batch_1.html
